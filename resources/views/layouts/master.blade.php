...
<head>
    ...
    <link href="{{asset('asset')}}/css/media_query.css" rel="stylesheet" type="text/css"/>
    ...
    <!-- Bootstrap CSS -->
    <link href="{{asset('asset')}}/css/style_1.css" rel="stylesheet" type="text/css"/>
    <link href="{{asset('asset')}}/css/style_3.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ route('contents')}}">All Contents <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('create_content')}}">Create Content <span class="sr-only">(current)</span></a>
                    </li>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5f006185d5e8ac77"></script>
